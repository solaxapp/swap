...
import {cache, getMultipleAccounts, MintParser, useCachedPool} from "../AccountsProvider";
import {PublicKey} from "@solana/web3.js";
import {convert, getPoolName, getTokenName} from "../../helper/token";
import {Market, MARKETS, Orderbook, TOKEN_MINTS} from "@project-serum/serum";
import {LIQUIDITY_PROVIDER_FEE, POOLS_WITH_AIRDROP, SERUM_FEE, STABLE_COINS} from "../../constants/app";
...
export const MINT_TO_MARKET = {};

export function MarketProvider({children = null}) {
...
function createEnrichedPools(pools, marketByMint, poolData, tokenMap) {
            ...
            if (p.pubkeys.feeAccount) {
                ...
                if (
                    ...
                    if (fees !== 0) {
                        ...
                        const apy24h0 =
                            parseFloat((volume24h * LIQUIDITY_PROVIDER_FEE * 356)) /
                            baseReserveUSD;
